...
public class ServiceTokenProvider {
    ...
    private static final String CLIENT_REGISTRATION_ID = "exchange-generator";
    private static final String PRINCIPAL_NAME = "exchange-generator";
    ...
    public String getAccessToken() {
        ...
        if (authorizedClient == null) {
            throw new ExchangeClientException("Service token request failed");
        }
